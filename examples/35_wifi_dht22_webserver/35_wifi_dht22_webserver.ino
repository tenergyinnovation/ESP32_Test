/*
 * ตัวอย่างโปรแกรม: ESP32 Web Server with DHT22 Sensor
 * =====================================================
 * โปรแกรมนี้สาธิตการสร้าง Web Server บน ESP32 ที่แสดงผลอุณหภูมิและความชื้น
 * จาก DHT22 sensor module พร้อมอัพเดทค่าแบบ real-time ทุกๆ 2 วินาที
 * 
 * การทำงาน:
 ...
 * 5. อัพเดทค่าอัตโนมัติทุกๆ 2 วินาทีด้วย AJAX
 * 6. แสดงผลพร้อมกันที่ Serial Monitor และจอ TM1638
 * 
 * หน้าเว็บประกอบด้วย:
 * - การ์ดแสดงอุณหภูมิพร้อมไอคอน thermometer
 * - การ์ดแสดงความชื้นพร้อมไอคอน droplet
 * - Gradient background สวยงาม
 * - Responsive design รองรับทุกขนาดหน้าจอ
 * - Animation เมื่ออัพเดทค่า
 ...
 * - esp32_iot.h     : สำหรับควบคุม TM1638 และฮาร์ดแวร์
 */
...
// ========================================
// ฟังก์ชันสร้างหน้า HTML หลัก พร้อม CSS และ JavaScript
void handleRoot() {
  // สร้าง HTML content
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>ระบบตรวจวัดอุณหภูมิและความชื้นแบบเรียลไทม์</p>
        </div>
...
// ========================================
// ฟังก์ชันส่งข้อมูลเซ็นเซอร์ในรูปแบบ JSON
void handleData() {
  // สร้าง JSON response
  String json = "{";
  ...
  Serial.println("API Request: /data");
...
// ========================================
// ฟังก์ชันจัดการกรณีเข้าถึง URL ที่ไม่มีอยู่
void handleNotFound() {
